...
function displayGraphExample(counterId, eventId, id, width, height, interpolation, animate, updateDelay, transitionDelay) {
...
socket.on(eventId, function (i) {
   console.log(i);
   data.shift(); // remove the first element of the array
   data.push(i);
   redrawWithAnimation();
   $("div."+counterId).text("rpm: "+i);
});
